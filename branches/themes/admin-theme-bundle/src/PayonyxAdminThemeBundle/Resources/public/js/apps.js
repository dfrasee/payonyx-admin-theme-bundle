...
var handleThemePageStructureControl = function() {
    ...
    if ($.cookie && $.cookie('theme')) {
        ...
        var cssFileSrc = THEME_PATH+'assets/css/theme/' + $.cookie('theme') + '.css';
    ...
    $('.theme-list [data-theme]').click(function() {
        var cssFileSrc = THEME_PATH+'assets/css/theme/' + $(this).attr('data-theme') + '.css';
        $('#theme').attr('href', cssFileSrc);
...
/* 10.1 Handle Language Configuration - custom
------------------------------------------------ */
var handleLanguageSetupControl = function() {
    // COOKIE - Theme File Setting
     $('.navbar-language a').on('click', function() {
        var lang = $(this).attr('data-original-title');
      
        $('#langselected').html($(this).find('span'));
        $('#langselected').append('<span class="name">'+lang+'</span>');
        $('#langselected').append('<b class="caret"></b>');
        $.cookie('lang', lang);
    });
...
/* 15. Handle Reset Local Storage - added in V1.5
------------------------------------------------ */
var resetLocalStorageConfirmation = null;
var handleResetLocalStorage = function() {
    ...
    $(document).on('click', '[data-click=reset-local-storage]', function(e) {
        ...
        resetLocalStorageConfirmation = $('[data-modal-id="reset-local-storage-confirmation"]').modal('show');
    });
    ...
    $(document).on('click', '[data-click=confirm-reset-local-storage]', function(e) {
        ...
        resetLocalStorageConfirmation.modal('hide');
        $('[data-modal-id="reset-local-storage-confirmation"]').remove();
